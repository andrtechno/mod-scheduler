...
return [
    ...
    'minutes' => [
        'every' => 'щохвилини',
        'increment' => 'кожні :increment {хвилина|хвилини|хвилин}',
    ...
    'days_of_month' => [
        'every' => 'щодня',
        'increment' => 'кожні :increment {день|дні|днів}',
    ...
    'months' => [
        'every' => 'щомісяця',
        'every_on_day' => 'щомісяця :day числа',
        'increment' => 'кожні :increment {місяць|місяці|місяців}',
    ...
    'days_of_week' => [
        ...
        'increment' => 'кожні :increment дні тижня',
