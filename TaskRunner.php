...
use Yii;
use panix\mod\scheduler\events\TaskEvent;
 ...
 * @property \panix\mod\scheduler\Task $task
 */
class TaskRunner extends \yii\base\Component
{
     ...
     *
     * @var \panix\mod\scheduler\Task
     */
    private $_task;

    /**
     * @var \panix\mod\scheduler\models\SchedulerLog
     */
    private $_log;
    ...
    /**
     * @param \panix\mod\scheduler\models\SchedulerLog $log
     */
    ...
    /**
     * If the yii error handler has been overridden with `\panix\mod\scheduler\ErrorHandler`,
    ...
    public function shutdownHandler()
    {
        ...
        if ($errorHandler instanceof \panix\mod\scheduler\ErrorHandler) {
