 ...
 *
 * @property \panix\mod\scheduler\models\SchedulerTask $schedulerTask
 */
class SchedulerLog extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(\panix\mod\scheduler\models\SchedulerTask::className(), ['id' => 'scheduler_task_id']);
    }
