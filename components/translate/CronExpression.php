...
namespace panix\mod\scheduler\components\translate;
...
class CronExpression
{
     ...
     */
    public function langCountable(string $type, int $number, string $case = 'nominative'): string
    {
     ...
     */
    protected function getArrayDot(array $array, string $key): string
    {
        $keys = explode('.', $key);
