    ...
    <div class="col-lg-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?= $form->field($model, 'active')->dropdownList([1 => Yii::t('yii', 'Yes'), 0 => Yii::t('yii', 'No')]);
                ?>
            </div>
            <div class="card-footer">
                <?= Html::submitButton(($model->isNewRecord ? Yii::t('app/default', 'CREATE') : Yii::t('app/default', 'UPDATE')), [
